...
class UpdateCheck(QDialog, Logger):
    url = "https://raw.githubusercontent.com/Apushii/electrum-frencoin/master/check-version.json"
    download_url = "https://github.com/Apushii/electrum-frencoin/releases"

    VERSION_ANNOUNCEMENT_SIGNING_KEYS = (
        "RPuQNvDVBC5Q4fXKyfYLjrunbyqiEYckP5",  # kralverde since frencoin fork
    )
