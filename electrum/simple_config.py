...
class SimpleConfig(Logger):
    ...
    BLOCK_EXPLORER = ConfigVar('block_explorer', default='fren.cryptoscope.io', type_=str)
    ...
    WIZARD_DONT_CREATE_SEGWIT = ConfigVar('nosegwit', default=True, type_=bool) # no segwit for FREN
